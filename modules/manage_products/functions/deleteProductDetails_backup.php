...
<html>
<head>
    <title>Delete Products | Product Catalog</title>
...
<table id="deleteProductDetails" border="4">
    <tr>
        <th>Sr No.</th>
    ...
    while ($rowProduct = $getProductDetails->fetch_assoc()) {
        ...
        echo "<td><button type='submit' class='deleteProduct'>Delete Product</button></td>";
        echo "</tr>";
