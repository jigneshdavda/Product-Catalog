    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-pencil"></i> Update Product Details</li>
            </ol>
        </section>
        <!-- Main content -->
...
<div class=\"box-tools pull-right\">
            ...
            <div class="table-container1">
                <table class="table table-bordered table-stripped" id="updateProductDetails" border="4">
                    <thead>
                    <tr>
                        <th>Sr No.</th>
                    ...
                    while ($rowProduct = $getProductDetails->fetch_assoc()) {
                        ...
                        echo "<td><a class='btn btn-flat btn-primary' href='update_product_details.php?productDetailsId=" . $productDetailsId . "'><i class='fa fa-pencil'></i> Edit Product</a></td>";
                        echo "</tr>";
