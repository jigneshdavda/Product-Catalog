...
<body>
<label><b><h2>Register at Product Catalog</h2></b></label>
<form id="register_form">
    Enter Company Name: <input type="text" id="company_name" placeholder="Enter Company Name"><br>
    Enter Company Email id: <input type="email" id="company_email_id" placeholder="Enter Email id"><br>
    Enter Company Phone Number: <input type="number" id="company_phone_number" placeholder="Enter Phone Number"><br>
    Enter Company Address Line 1: <textarea id="company_address_line_1"
                                            placeholder="Enter Address Line 1"></textarea><br>
    Enter Company Address Line 2: <textarea id="company_address_line_2"
                                            placeholder="Enter Address Line 2"></textarea><br>
    Company Location:
    <label>
    ...
    Enter Password: <input type="password" id="company_password" placeholder="Password"><br>
    Re-type Password: <input type="password" id="company_retype_password" placeholder="Re-type Password"><br>
    <button type="reset" value="reset">Reset</button>
    <button type="submit" id="submit_form" value="register">Register</button>
    <br>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#submit_form").on("click", function (event) {
            ...
            var companyEmailId = $("#company_email_id").val();
            var companyPhoneNumber = $("#company_phone_number").val();
            var companyAddressLine1 = $("#company_address_line_1").val();
            var companyAddressLine2 = $("#company_address_line_2").val();
            var companyCountry = $("#company_country").find('option:selected').val();
            var companyPassword = $("#company_password").val();
            var companyReTypePassword = $("#company_retype_password").val();

            if (companyName === "" || companyEmailId === "" || companyPhoneNumber === ""
                || companyAddressLine1 === "" || companyAddressLine2 === "" || companyCountry === ""
                || companyPassword === "" || companyReTypePassword === "") {
                alert("Fill all values");
            } else {
                if (companyPassword === companyReTypePassword) {
                    companyDetails.push([companyName, companyEmailId, companyPhoneNumber,
...
//                    console.log(companyDetails);
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        data: {companyDetailsArray: companyDetails},
                        dataType: 'JSON',
