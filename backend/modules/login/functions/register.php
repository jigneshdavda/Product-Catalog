...
<div class="register-box">
    ...
    <div class="register-box-body">
        ...
        <form id="register_form">
            ...
            <div class="form-group has-feedback">
                <label for="company_country">Company Location:</label>
...
<!-- Select2 -->
<script src="../../../../Resources/AdminLTE-2.4.2/bower_components/select2/dist/js/select2.full.min.js"></script>
<script>
    $(function () {
