...
require_once("backend/modules/manage_products/classes/ProductBrand.php");
require_once("backend/modules/manage_products/classes/ProductCategory.php");
require_once("backend/modules/manage_products/classes/ProductsDetails.php");
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="credits">
                        Copyrights&nbsp;@&nbsp;All rights reserved&nbsp;|&nbsp;<a href="#"><h6>Product Catalog</h6></a>
                    </div>
                </div>
            </div>
        </div>
